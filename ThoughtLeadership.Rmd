...
---
title: "Thought Leadership Budget & Engagement Analysis"
...
tl_data <- read_excel("data/thought_leadership_survey_mock_data.xlsx", sheet = "Raw Data Labels_N=4000") %>%
  clean_names() %>%
  rename(
    revenue = s7,
    tl_budget = q2_29
...
## 📊 Budget Allocation by Revenue Bracket

```{r}
# Create contingency table
contingency_table <- table(tl_data$revenue, tl_data$tl_budget)
